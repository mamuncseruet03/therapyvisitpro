...
export default function AdminDashboard() {
  ...
  // Weekly scheduled visits (status = "scheduled", visit_date within current week)
  const now = new Date();
  ...
  // Delayed visits: scheduled this week with no time in/out
  ...
  // Missed visits: for past weeks where completed visits < approved frequency
  ...
  for (const assignment of assignments) {
    ...
    for (const week of assignment.approved_weekly_visits) {
      ...
      if (wEnd >= today) continue; // only past weeks
